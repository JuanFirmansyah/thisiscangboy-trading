...
const START_STEPS: { title: string; description: string }[] = [
  { title: "Pilih platform", description: "Lihat rekomendasi." },
  { title: "Ikuti panduan", description: "Screenshot tersedia." },
  { title: "Daftar & verifikasi", description: "Ikuti instruksi." },
  { title: "Siap trading", description: "Akun aktif." },
];
...
export default function HomePage() {
  ...
  const bigAccentMap: Record<string, string> = {
    amber:
      "from-amber-400 to-orange-500 shadow-amber-500/30 text-amber-100",
    emerald:
      "from-emerald-400 to-teal-500 shadow-emerald-500/30 text-emerald-100",
  };
    ...
    >
      ...
      <main className="mx-auto max-w-2xl px-5 pb-32 pt-10">
        ...
        <section className="relative">
          ...
          >
            ...
            <div className="relative h-12 w-12 shrink-0">
              ...
              <span className="absolute -bottom-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full border-2 border-[#08090c] bg-emerald-500 dark:border-[#08090c]">
        ...
        <section className="relative mt-8">
          {platform.steps.map((step: GuideStep, i: number) => {
            ...
            const isLast = i === platform.steps.length - 1;
            return (
              <motion.div
                key={step.id}
        ...
        <section className="mt-16">
          ...
          >
            ...
            <div className="relative">
              ...
              >
                Saya bantu arahkan langkahnya, dari pemilihan platform sampai
                verifikasi akun.
              </p>
              <motion.a
                whileHover={{ y: -2 }}
          ...
          >
            ...
            <div className="leading-relaxed">
              ...
              <p className="mt-1.5">
                ...
                Halaman ini hanya menyediakan link referensi dan edukasi umum.
                Tidak ada jaminan keuntungan.
              </p>
              <p className="mt-1.5 font-bold text-slate-600 dark:text-slate-400">
                Jangan pernah bagikan password, OTP, atau API key kepada siapa
                pun.
              </p>
            </div>
          </div>
        ...
        {/* ================= FOOTER ================= */}
        <footer className="mt-12 flex flex-col items-center gap-3 border-t border-white/[0.06] pt-8 dark:border-white/[0.06]">
          <div className="flex items-center gap-2">
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 flex justify-center px-4 pb-4">
        <motion.a
          ...
          whileTap={{ scale: 0.97 }}
          href="#guide"
          className="pointer-events-auto flex w-full max-w-md items-center justify-between gap-2 rounded-full border border-amber-400/30 bg-[#08090c]/90 px-2 py-2 pl-5 shadow-2xl shadow-amber-500/20 backdrop-blur-xl dark:bg-[#08090c]/90"
        >
        ...
        {celebrate && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative mx-4 max-w-sm overflow-hidden rounded-3xl border border-amber-400/30 bg-[#08090c] p-8 text-center shadow-2xl"
            >
              ...
              <motion.div
                ...
                className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-orange-500 shadow-lg shadow-amber-500/50"
              >
              ...
              <p className="mt-2 text-sm text-slate-400">
                Semua langkah panduan sudah kamu selesaikan. Tinggal lanjut di
                platform.
              </p>
              <button
                type="button"
                onClick={() => setCelebrate(false)}
                className="mt-5 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-400 to-orange-500 px-6 py-2.5 font-mono text-[11px] font-black uppercase tracking-wider text-black shadow-lg shadow-amber-500/40 transition hover:scale-[1.03]"
              >
                OK
              </button>
            </motion.div>
...
// Helper to handle SSR-safe dark check inside SectionHeader
function dark_text_placeholder() {
  return true;
}